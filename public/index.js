  ...
  var require_react_development = __commonJS((exports) => {
    ...
    if (true) {
      (function() {
        ...
        function hasValidRef(config7) {
          {
            if (hasOwnProperty.call(config7, "ref")) {
              var getter = Object.getOwnPropertyDescriptor(config7, "ref").get;
              if (getter && getter.isReactWarning) {
                return false;
              }
            }
          }
          return config7.ref !== void 0;
        }
        function hasValidKey(config7) {
          {
            if (hasOwnProperty.call(config7, "key")) {
              var getter = Object.getOwnPropertyDescriptor(config7, "key").get;
              if (getter && getter.isReactWarning) {
                return false;
              }
            }
          }
          return config7.key !== void 0;
        }
        ...
        function warnIfStringRefCannotBeAutoConverted(config7) {
          {
            if (typeof config7.ref === "string" && ReactCurrentOwner.current && config7.__self && ReactCurrentOwner.current.stateNode !== config7.__self) {
              var componentName = getComponentName(ReactCurrentOwner.current.type);
              if (!didWarnAboutStringRefs[componentName]) {
                error('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', componentName, config7.ref);
        ...
        function createElement(type, config7, children) {
          var propName;
          var props = {};
          var key = null;
          var ref = null;
          ...
          var source = null;
          if (config7 != null) {
            if (hasValidRef(config7)) {
              ref = config7.ref;
              {
                warnIfStringRefCannotBeAutoConverted(config7);
              }
            }
            if (hasValidKey(config7)) {
              key = "" + config7.key;
            }
            self = config7.__self === void 0 ? null : config7.__self;
            source = config7.__source === void 0 ? null : config7.__source;
            for (propName in config7) {
              if (hasOwnProperty.call(config7, propName) && !RESERVED_PROPS.hasOwnProperty(propName)) {
                props[propName] = config7[propName];
              }
            }
          }
        ...
        function cloneElement(element, config7, children) {
          ...
          if (config7 != null) {
            ...
            for (propName in config7) {
              if (hasOwnProperty.call(config7, propName) && !RESERVED_PROPS.hasOwnProperty(propName)) {
                if (config7[propName] === void 0 && defaultProps !== void 0) {
                  props[propName] = defaultProps[propName];
                } else {
                  props[propName] = config7[propName];
                }
  ...
  var require_react_dom_development = __commonJS((exports) => {
    ...
    if (true) {
      (function() {
        ...
        function batchedUpdates3(fn, bookkeeping) {
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
        ...
        var findHostInstancesForRefresh = function(root2, families) {
          {
            ...
            var types5 = new Set(families.map(function(family) {
              return family.current;
            }));
            findHostInstancesForMatchingFibersRecursively(root2.current, types5, hostInstances);
            return hostInstances;
          }
        };
        function findHostInstancesForMatchingFibersRecursively(fiber, types5, hostInstances) {
          {
            ...
            if (didMatch) {
              ...
              if (child !== null) {
                findHostInstancesForMatchingFibersRecursively(child, types5, hostInstances);
              }
            }
            if (sibling !== null) {
              findHostInstancesForMatchingFibersRecursively(sibling, types5, hostInstances);
            }
          }
        }
  ...
  (function(QueryStatus2) {
    QueryStatus2["Idle"] = "idle";
    QueryStatus2["Loading"] = "loading";
    QueryStatus2["Error"] = "error";
    QueryStatus2["Success"] = "success";
  })(QueryStatus || (QueryStatus = {}));

  // node_modules/react-query/es/core/utils.js
  var CancelledError = function CancelledError2(silent) {
    this.silent = silent;
  };
  var _uid = 0;
  function uid() {
  ...
  function getQueryArgs(arg1, arg2, arg3, arg4) {
    ...
    config7 = config7 || {};
    if (queryFn2) {
      config7 = _extends({}, config7, {
        queryFn: queryFn2
      });
    }
    return [queryKey, config7, options];
  }
  ...
  var defaultQueryKeySerializerFn = function defaultQueryKeySerializerFn2(queryKey) {
    try {
  ...
  var DEFAULT_CONFIG = {
    queries: {
      ...
      retryDelay: function retryDelay(attemptIndex) {
        return Math.min(1e3 * Math.pow(2, attemptIndex), 3e4);
      },
      staleTime: 0,
      structuralSharing: true
    }
  };
  function getResolvedQueryConfig(queryCache4, queryKey, contextConfig, config7) {
    var queryCacheConfig = queryCache4.getDefaultConfig();
    var resolvedConfig = _extends({}, DEFAULT_CONFIG.queries, queryCacheConfig == null ? void 0 : queryCacheConfig.shared, queryCacheConfig == null ? void 0 : queryCacheConfig.queries, contextConfig == null ? void 0 : contextConfig.shared, contextConfig == null ? void 0 : contextConfig.queries, config7);
    var result = resolvedConfig.queryKeySerializerFn(queryKey);
    resolvedConfig.queryCache = queryCache4;
    resolvedConfig.queryHash = result[0];
    resolvedConfig.queryKey = result[1];
    return resolvedConfig;
  }
  function isResolvedQueryConfig(config7) {
    return Boolean(config7.queryHash);
  }
  function getResolvedMutationConfig(queryCache4, contextConfig, config7) {
    var queryCacheConfig = queryCache4.getDefaultConfig();
    return _extends({}, DEFAULT_CONFIG.mutations, queryCacheConfig == null ? void 0 : queryCacheConfig.shared, queryCacheConfig == null ? void 0 : queryCacheConfig.mutations, contextConfig == null ? void 0 : contextConfig.shared, contextConfig == null ? void 0 : contextConfig.mutations, config7);
  }
  ...
  var NotifyManager = /* @__PURE__ */ function() {
    ...
    _proto.flush = function flush() {
      ...
      if (queue.length) {
        scheduleMicrotask(function() {
          var batchedUpdates3 = getBatchedUpdates();
          batchedUpdates3(function() {
  ...
  var QueryObserver = /* @__PURE__ */ function() {
    function QueryObserver2(config7) {
      this.config = config7;
      this.isStale = true;
    ...
    _proto.updateConfig = function updateConfig(config7) {
      var prevConfig = this.config;
      var prevQuery = this.currentQuery;
      this.config = isResolvedQueryConfig(config7) ? config7 : this.config.queryCache.getResolvedQueryConfig(this.config.queryKey, config7);
      this.updateQuery();
      if (!this.listener) {
        return;
      }
      ...
      if (config7.enabled && !prevConfig.enabled) {
        this.optionalFetch();
      }
      if (config7.enabled !== prevConfig.enabled || config7.staleTime !== prevConfig.staleTime) {
        this.updateStaleTimeout();
      }
      if (config7.enabled !== prevConfig.enabled || config7.refetchInterval !== prevConfig.refetchInterval) {
    ...
    _proto.fetch = function fetch2() {
      ...
      return this.currentQuery.fetch(void 0, this.config).catch(noop);
    };
    _proto.optionalFetch = function optionalFetch() {
      if (this.config.enabled && this.isStale && !(this.config.suspense && this.currentResult.isFetched) && (this.config.refetchOnMount || this.currentQuery.observers.length === 1)) {
        this.fetch();
      }
    };
    ...
    _proto.updateResult = function updateResult() {
      ...
      var data = state.data, status = state.status, updatedAt = state.updatedAt;
    ...
    _proto.updateQuery = function updateQuery() {
      var config7 = this.config;
      var prevQuery = this.currentQuery;
      var query2 = config7.queryCache.getQueryByHash(config7.queryHash);
      if (!query2) {
        query2 = config7.queryCache.createQuery(config7);
      }
      if (query2 === prevQuery) {
        return;
      }
      ...
      this.initialUpdateCount = query2.state.updateCount;
      if (query2.state.isInitialData) {
        if (config7.keepPreviousData && prevQuery) {
          this.isStale = true;
        } else if (typeof config7.initialStale === "function") {
          this.isStale = config7.initialStale();
        } else if (typeof config7.initialStale === "boolean") {
          this.isStale = config7.initialStale;
        } else {
          this.isStale = typeof query2.state.data === "undefined";
        }
      } else {
        this.isStale = query2.isStaleByTime(config7.staleTime);
      }
      this.updateResult();
      if (this.listener) {
    ...
    _proto.onQueryUpdate = function onQueryUpdate(action) {
      ...
      if (type === 2 || type === 3 || type === 4) {
        this.isStale = this.currentQuery.isStaleByTime(config7.staleTime);
      }
      ...
      if (config7.notifyOnStatusChange || currentResult.data !== prevResult.data || currentResult.error !== prevResult.error) {
        notifyOptions.listener = true;
      }
      this.notify(notifyOptions);
    };
    _proto.notify = function notify(options) {
      var config7 = this.config, currentResult = this.currentResult, currentQuery = this.currentQuery, listener = this.listener;
      var onSuccess = config7.onSuccess, onSettled = config7.onSettled, onError = config7.onError;
      notifyManager.batch(function() {
        if (options.onSuccess) {
          ...
          if (onSettled) {
            notifyManager.schedule(function() {
              onSettled(void 0, currentResult.error);
            });
          }
        }
        ...
        if (options.globalListeners) {
          config7.queryCache.notifyGlobalListeners(currentQuery);
        }
      });
    };
  ...
  var Query = /* @__PURE__ */ function() {
    function Query2(config7) {
      this.config = config7;
      this.queryKey = config7.queryKey;
      this.queryHash = config7.queryHash;
      this.queryCache = config7.queryCache;
      this.cacheTime = config7.cacheTime;
      this.observers = [];
      this.state = getDefaultState(config7);
      this.scheduleGc();
    }
    var _proto = Query2.prototype;
    _proto.updateConfig = function updateConfig(config7) {
      this.config = config7;
      this.cacheTime = Math.max(this.cacheTime, config7.cacheTime);
    };
    ...
    _proto.setData = function setData(updater, options) {
      ...
      var canFetchMore = hasMorePages(this.config, data);
      this.dispatch({
    ...
    _proto.onInteraction = function onInteraction(type) {
      var staleObserver = this.observers.find(function(observer) {
        var config7 = observer.config;
        var _observer$getCurrentR = observer.getCurrentResult(), isStale = _observer$getCurrentR.isStale;
        return config7.enabled && (type === "focus" && (config7.refetchOnWindowFocus === "always" || config7.refetchOnWindowFocus && isStale) || type === "online" && (config7.refetchOnReconnect === "always" || config7.refetchOnReconnect && isStale));
      });
      if (staleObserver) {
        staleObserver.fetch();
      }
    ...
    _proto.refetch = function refetch(options, config7) {
      var promise = this.fetch(void 0, config7);
      if (!(options == null ? void 0 : options.throwOnError)) {
        promise = promise.catch(noop);
      }
      return promise;
    };
    _proto.fetchMore = function fetchMore(fetchMoreVariable, options, config7) {
      return this.fetch({
        fetchMore: {
          fetchMoreVariable,
    ...
    _proto.fetch = function fetch2(options, config7) {
      try {
        var _exit2 = false;
        var _this4 = this;
        return _invoke(function() {
          ...
          if (_exit2)
            return _result2;
          if (config7) {
            _this4.updateConfig(config7);
          }
          config7 = _this4.config;
          var filter = config7.queryFnParamsFilter;
          ...
          _this4.promise = _async(function() {
            return _catch(function() {
              ...
              return _invoke(function() {
                if (config7.infinite) {
                  return _await(_this4.startInfiniteFetch(config7, params, options), function(_this4$startInfiniteF) {
                    data = _this4$startInfiniteF;
                  });
                } else {
                  return _await(_this4.startFetch(config7, params, options), function(_this4$startFetch) {
                    data = _this4$startFetch;
                  });
                }
              }, function() {
                _this4.setData(data);
                delete _this4.promise;
                return data;
              });
            }, function(error) {
    ...
    _proto.startFetch = function startFetch(config7, params, _options) {
      var fetchData = function fetchData2() {
        return config7.queryFn.apply(config7, params);
      };
      ...
      return this.tryFetchData(config7, fetchData);
    };
    _proto.startInfiniteFetch = function startInfiniteFetch(config7, params, options) {
      var fetchMore = options == null ? void 0 : options.fetchMore;
      var _ref = fetchMore || {}, previous = _ref.previous, fetchMoreVariable = _ref.fetchMoreVariable;
      var isFetchingMore = fetchMore ? previous ? "previous" : "next" : false;
      var prevPages = this.state.data || [];
      var fetchPage = _async(function(pages, prepend, cursor) {
        var lastPage = getLastPage(pages, prepend);
        if (typeof cursor === "undefined" && typeof lastPage !== "undefined" && config7.getFetchMore) {
          cursor = config7.getFetchMore(lastPage, pages);
        }
        return !Boolean(cursor) && typeof lastPage !== "undefined" ? pages : _await(config7.queryFn.apply(config7, params.concat([cursor])), function(page) {
    ...
    _proto.tryFetchData = function tryFetchData(config7, fn) {
      var _this5 = this;
      return new Promise(function(outerResolve, outerReject) {
        ...
        var done = function done2() {
          ...
          delete _this5.isTransportCancelable;
        ...
        var run = _async(function() {
          return _catch(function() {
            ...
            if (isCancelable(promiseOrValue)) {
              cancelTransport = function cancelTransport2() {
                try {
            ...
            var retry = config7.retry, retryDelay2 = config7.retryDelay;
            ...
            return _await(sleep(functionalUpdate(retryDelay2, failureCount) || 0), function() {
              return _invoke(function() {
  ...
  function hasMorePages(config7, pages, previous) {
    if (config7.infinite && config7.getFetchMore && Array.isArray(pages)) {
      return Boolean(config7.getFetchMore(getLastPage(pages, previous), pages));
    }
  }
  function getDefaultState(config7) {
    var data = typeof config7.initialData === "function" ? config7.initialData() : config7.initialData;
    var status = typeof data !== "undefined" ? QueryStatus.Success : config7.enabled ? QueryStatus.Loading : QueryStatus.Idle;
    return {
      canFetchMore: hasMorePages(config7, data),
      data,
      error: null,
      failureCount: 0,
  ...
  var QueryCache = /* @__PURE__ */ function() {
    ...
    _proto.notifyGlobalListeners = function notifyGlobalListeners(query2) {
      var _this = this;
    ...
    _proto.getResolvedQueryConfig = function getResolvedQueryConfig2(queryKey, config7) {
      return getResolvedQueryConfig(this, queryKey, void 0, config7);
    };
    _proto.subscribe = function subscribe(listener) {
      var _this2 = this;
    ...
    _proto.getQueries = function getQueries(predicate, options) {
      ...
      if (typeof predicate === "function") {
        ...
        var _ref = options || {}, exact = _ref.exact, active = _ref.active, stale = _ref.stale;
        var resolvedConfig = this.getResolvedQueryConfig(predicate);
        predicateFn = function predicateFn2(query2) {
          if (!anyKey) {
            if (exact) {
              if (query2.queryHash !== resolvedConfig.queryHash) {
                return false;
              }
            } else {
              if (!deepIncludes(query2.queryKey, resolvedConfig.queryKey)) {
                return false;
              }
            }
          }
          if (typeof active === "boolean" && query2.isActive() !== active) {
            return false;
          }
    ...
    _proto.removeQuery = function removeQuery(query2) {
      if (this.queries[query2.queryHash]) {
        query2.destroy();
        delete this.queries[query2.queryHash];
        this.queriesArray = this.queriesArray.filter(function(x) {
          return x !== query2;
        });
        this.notifyGlobalListeners(query2);
      }
    };
    _proto.removeQueries = function removeQueries(predicate, options) {
      var _this3 = this;
      this.getQueries(predicate, options).forEach(function(query2) {
        _this3.removeQuery(query2);
      });
    };
    ...
    _proto.invalidateQueries = function invalidateQueries(predicate, options) {
      ...
      var _ref2 = options || {}, _ref2$refetchActive = _ref2.refetchActive, refetchActive = _ref2$refetchActive === void 0 ? true : _ref2$refetchActive, _ref2$refetchInactive = _ref2.refetchInactive, refetchInactive = _ref2$refetchInactive === void 0 ? false : _ref2$refetchInactive;
    ...
    _proto.refetchQueries = function refetchQueries(predicate, options) {
      ...
      var promises = [];
      notifyManager.batch(function() {
        _this4.getQueries(predicate, options).forEach(function(query2) {
          var promise = query2.fetch().then(function() {
            return query2;
          });
          if (!(options == null ? void 0 : options.throwOnError)) {
            promise = promise.catch(function() {
    ...
    _proto.resetErrorBoundaries = function resetErrorBoundaries() {
      this.getQueries().forEach(function(query2) {
        query2.state.throwInErrorBoundary = false;
      });
    };
    _proto.buildQuery = function buildQuery(queryKey, config7) {
      var resolvedConfig = this.getResolvedQueryConfig(queryKey, config7);
      var query2 = this.getQueryByHash(resolvedConfig.queryHash);
      if (!query2) {
        query2 = this.createQuery(resolvedConfig);
      }
      return query2;
    };
    _proto.createQuery = function createQuery(config7) {
      var query2 = new Query(config7);
      if (!this.config.frozen) {
        this.queries[query2.queryHash] = query2;
        this.queriesArray.push(query2);
        this.notifyGlobalListeners(query2);
      }
      return query2;
    };
    _proto.fetchQuery = function fetchQuery(arg1, arg2, arg3) {
      var _getQueryArgs = getQueryArgs(arg1, arg2, arg3), queryKey = _getQueryArgs[0], config7 = _getQueryArgs[1];
      ...
      if (!query2.isStaleByTime(config7.staleTime)) {
        return Promise.resolve(query2.state.data);
      }
      return query2.fetch(void 0, resolvedConfig);
    };
    _proto.prefetchQuery = function prefetchQuery(arg1, arg2, arg3, arg4) {
      ...
      var _getQueryArgs2 = getQueryArgs(arg1, arg2, arg3, arg4), queryKey = _getQueryArgs2[0], config7 = _getQueryArgs2[1], options = _getQueryArgs2[2];
      if (options == null ? void 0 : options.force) {
        config7.staleTime = 0;
      }
      var promise = this.fetchQuery(queryKey, config7);
      if (!(options == null ? void 0 : options.throwOnError)) {
        promise = promise.catch(noop);
      }
      return promise;
    ...
    _proto.watchQuery = function watchQuery(arg1, arg2, arg3) {
      var _getQueryArgs3 = getQueryArgs(arg1, arg2, arg3), queryKey = _getQueryArgs3[0], config7 = _getQueryArgs3[1];
      var resolvedConfig = this.getResolvedQueryConfig(queryKey, config7);
      return new QueryObserver(resolvedConfig);
    };
    _proto.setQueryData = function setQueryData(queryKey, updater, config7) {
      this.buildQuery(queryKey, config7).setData(updater);
    };
    return QueryCache2;
  }();
  ...
  function onVisibilityOrOnlineChange(type) {
    if (isDocumentVisible() && isOnline()) {
      notifyManager.batch(function() {
        queryCaches.forEach(function(queryCache4) {
          queryCache4.getQueries().forEach(function(query2) {
            query2.onInteraction(type);
          });
        });
      });
    }
  ...
  var unstable_batchedUpdates = react_dom.default.unstable_batchedUpdates;

  // node_modules/react-query/es/react/ReactQueryCacheProvider.js
  var react = __toModule(require_react());
  var queryCacheContext = /* @__PURE__ */ react.default.createContext(defaultQueryCache);
  var useQueryCache = function useQueryCache2() {
    return react.default.useContext(queryCacheContext);
  };

  // node_modules/react-query/es/react/ReactQueryConfigProvider.js
  var react2 = __toModule(require_react());
  var configContext = /* @__PURE__ */ react2.default.createContext(void 0);
  function useContextConfig() {
    return react2.default.useContext(configContext);
  }
  ...
  var context = /* @__PURE__ */ react3.default.createContext(createValue());
  var useErrorResetBoundary = function useErrorResetBoundary2() {
    return react3.default.useContext(context);
  };
  ...
  function useIsMounted() {
    var mountedRef = react4.default.useRef(false);
    var isMounted = react4.default.useCallback(function() {
      return mountedRef.current;
    }, []);
    react4.default[isServer ? "useEffect" : "useLayoutEffect"](function() {
  ...
  function useMountedCallback(callback) {
    ...
    return react4.default.useCallback(function() {
      if (isMounted()) {
  ...
  function useMutation(mutationFn, config7) {
    if (config7 === void 0) {
      config7 = {};
    }
    var cache = useQueryCache();
    var contextConfig = useContextConfig();
    var resolvedConfig = getResolvedMutationConfig(cache, contextConfig, config7);
    var _React$useReducer = react6.default.useReducer(mutationReducer, null, getDefaultState2), state = _React$useReducer[0], unsafeDispatch = _React$useReducer[1];
    var dispatch = useMountedCallback(unsafeDispatch);
    var latestMutationRef = react6.default.useRef();
    var latestMutationFnRef = react6.default.useRef(mutationFn);
    latestMutationFnRef.current = mutationFn;
    var latestConfigRef = react6.default.useRef(resolvedConfig);
    latestConfigRef.current = resolvedConfig;
    var mutate = react6.default.useCallback(_async2(function(variables, mutateConfig) {
      ...
      var isLatest = function isLatest2() {
        return latestMutationRef.current === mutationId;
      };
      var snapshotValue;
      return _catch2(function() {
        dispatch({
          type: ActionType2.Loading
        });
        return _await2(latestConfig.onMutate == null ? void 0 : latestConfig.onMutate(variables), function(_latestConfig$onMutat) {
          snapshotValue = _latestConfig$onMutat;
          var latestMutationFn = latestMutationFnRef.current;
          return _await2(latestMutationFn(variables), function(data) {
            if (isLatest()) {
              dispatch({
                type: ActionType2.Resolve,
                data
              });
            }
            return _await2(latestConfig.onSuccess == null ? void 0 : latestConfig.onSuccess(data, variables), function() {
              return _await2(mutateConfig.onSuccess == null ? void 0 : mutateConfig.onSuccess(data, variables), function() {
                return _await2(latestConfig.onSettled == null ? void 0 : latestConfig.onSettled(data, null, variables), function() {
                  return _await2(mutateConfig.onSettled == null ? void 0 : mutateConfig.onSettled(data, null, variables), function() {
                    return data;
                  });
                });
              });
        ...
        Console.error(error);
        return _await2(latestConfig.onError == null ? void 0 : latestConfig.onError(error, variables, snapshotValue), function() {
          return _await2(mutateConfig.onError == null ? void 0 : mutateConfig.onError(error, variables, snapshotValue), function() {
            return _await2(latestConfig.onSettled == null ? void 0 : latestConfig.onSettled(void 0, error, variables, snapshotValue), function() {
              return _await2(mutateConfig.onSettled == null ? void 0 : mutateConfig.onSettled(void 0, error, variables, snapshotValue), function() {
                if (isLatest()) {
                  dispatch({
                    type: ActionType2.Reject,
                    error
                  });
                }
    ...
    react6.default.useEffect(function() {
      var latestConfig = latestConfigRef.current;
      var suspense = latestConfig.suspense, useErrorBoundary = latestConfig.useErrorBoundary;
      if ((useErrorBoundary || suspense) && state.error) {
        throw state.error;
      }
    }, [state.error]);
    var reset = react6.default.useCallback(function() {
      dispatch({
        type: ActionType2.Reset
      });
    }, [dispatch]);
  ...
  function useBaseQuery(queryKey, config7) {
    var _React$useReducer = react7.default.useReducer(function(c) {
      return c + 1;
    }, 0), rerender = _React$useReducer[1];
    var isMounted = useIsMounted();
    var cache = useQueryCache();
    var contextConfig = useContextConfig();
    var errorResetBoundary = useErrorResetBoundary();
    var resolvedConfig = getResolvedQueryConfig(cache, queryKey, contextConfig, config7);
    var observerRef = react7.default.useRef();
    var firstRender = !observerRef.current;
    var observer = observerRef.current || new QueryObserver(resolvedConfig);
    observerRef.current = observer;
    react7.default.useEffect(function() {
    ...
    if (resolvedConfig.suspense || resolvedConfig.useErrorBoundary) {
      var query2 = observer.getCurrentQuery();
      if (result.isError && !errorResetBoundary.isReset() && query2.state.throwInErrorBoundary) {
        throw result.error;
      }
  ...
  function useQuery(arg1, arg2, arg3) {
    var _getQueryArgs = getQueryArgs(arg1, arg2, arg3), queryKey = _getQueryArgs[0], config7 = _getQueryArgs[1];
    return useBaseQuery(queryKey, config7);
  }
  ...
  var fetchByQuery = async (query2, variables = {}) => {
  ...
  var Post = ({title, body}) => {
    return /* @__PURE__ */ react8.default.createElement("div", {
      className: "blog-post"
    }, /* @__PURE__ */ react8.default.createElement("h2", {
      className: "blog-post-title"
    }, title), /* @__PURE__ */ react8.default.createElement("p", {
  ...
  var Posts = () => {
    ...
    return /* @__PURE__ */ react8.default.createElement("div", null, status === "success" && posts.map(({id, title, body}) => /* @__PURE__ */ react8.default.createElement(Post, {
      key: id,
      title,
      body
    })));
  ...
  var PostForm = () => {
    const queryCache4 = useQueryCache();
    const [title, setTitle] = react10.useState("");
    const [body, setBody] = react10.useState("");
    ...
    return /* @__PURE__ */ react9.default.createElement("form", {
      onSubmit: createPost
    }, /* @__PURE__ */ react9.default.createElement("div", {
      className: "row"
    }, /* @__PURE__ */ react9.default.createElement("div", {
      className: "col-md-12 mb-3"
    }, /* @__PURE__ */ react9.default.createElement("label", {
      htmlFor: "title"
    }, "Title"), /* @__PURE__ */ react9.default.createElement("input", {
      type: "text",
      ...
      className: "col-md-12 mb-3 form-group"
    }, /* @__PURE__ */ react9.default.createElement("label", {
      htmlFor: "body"
    }, "Body"), /* @__PURE__ */ react9.default.createElement("textarea", {
      id: "body",
      className: "form-control",
      rows: "5",
      width: "100%",
    ...
    }))), /* @__PURE__ */ react9.default.createElement("button", {
      type: "submit"
    }, "Submit"));
  };
  ...
  // src/Sidebar.jsx
  var Post2 = ({title}) => {
    return /* @__PURE__ */ react11.default.createElement("li", null, /* @__PURE__ */ react11.default.createElement("a", {
      href: "#"
    }, title));
  };
  var Sidebar = () => {
    ...
    return /* @__PURE__ */ react11.default.createElement("aside", {
      className: "col-md-4 blog-sidebar"
    }, /* @__PURE__ */ react11.default.createElement("div", {
      className: "p-4"
    }, /* @__PURE__ */ react11.default.createElement("h4", {
      className: "font-italic"
    }, "Archives"), /* @__PURE__ */ react11.default.createElement("ol", {
      className: "list-unstyled mb-0"
    }, posts.map(({id, title}) => /* @__PURE__ */ react11.default.createElement(Post2, {
      key: id,
      title
    })))), /* @__PURE__ */ react11.default.createElement("div", {
      className: "p-4"
      ...
      className: "font-italic"
    }, "Create Post"), /* @__PURE__ */ react11.default.createElement(PostForm_default, null)));
  };
